...
*/
void insere (Terminal* aluno, TipoLista* lista);
...
*/
Terminal* retira (TipoLista* lista, int mat);

Celula* buscaTerminal(Terminal* terminal);
...
*/
Terminal* inicializaTerminal(char* nome, int matricula, char* endereco);
