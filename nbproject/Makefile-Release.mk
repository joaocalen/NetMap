...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/netmap

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/netmap: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/netmap ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Enlace.o: Enlace.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/Roteador.o: Roteador.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Roteador.o Roteador.c
...
${OBJECTDIR}/Enlace_nomain.o: ${OBJECTDIR}/Enlace.o Enlace.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/Enlace.o`; \
...
${OBJECTDIR}/Roteador_nomain.o: ${OBJECTDIR}/Roteador.o Roteador.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Roteador_nomain.o Roteador.c;\
	else  \
	    ${CP} ${OBJECTDIR}/Roteador.o ${OBJECTDIR}/Roteador_nomain.o;\
	fi

${OBJECTDIR}/Terminal_nomain.o: ${OBJECTDIR}/Terminal.o Terminal.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/Terminal.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terminal_nomain.o Terminal.c;\
	else  \
...
${OBJECTDIR}/caminho_nomain.o: ${OBJECTDIR}/caminho.o caminho.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/caminho_nomain.o caminho.c;\
	else  \
...
${OBJECTDIR}/fila_nomain.o: ${OBJECTDIR}/fila.o fila.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fila_nomain.o fila.c;\
	else  \
...
${OBJECTDIR}/leitorArquivo_nomain.o: ${OBJECTDIR}/leitorArquivo.o leitorArquivo.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/leitorArquivo.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/leitorArquivo_nomain.o leitorArquivo.c;\
	else  \
	    ${CP} ${OBJECTDIR}/leitorArquivo.o ${OBJECTDIR}/leitorArquivo_nomain.o;\
	fi
